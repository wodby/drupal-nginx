...
nginxExec curl -s -I "localhost" | grep '302 Moved Temporarily'
nginxExec curl -s -I "localhost/cron.php" | grep '302 Moved Temporarily'
nginxExec curl -s -I "localhost/index.php" | grep '302 Moved Temporarily'
nginxExec curl -s -I "localhost/install.php?profile=default" | grep '200 OK'
nginxExec curl -s -I "localhost/update.php" | grep '200 OK'
