...
nginxExec curl -I "localhost" | grep '302 Moved Temporarily'
echo -n "cron.php...        "
nginxExec curl -I "localhost/cron.php" | grep '302 Moved Temporarily'
echo -n "index.php...       "
nginxExec curl -I "localhost/index.php" | grep '302 Moved Temporarily'
echo -n "install.php...     "
nginxExec curl -I "localhost/install.php?profile=default" | grep '200 OK'
echo -n "update.php...      "
